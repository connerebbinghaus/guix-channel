...
(define-module (conner systems desktop)
  ...
  #:use-module (conner services kerberos)
  ...
  #:use-module ((gnu services kerberos) #:select (krb5-service-type krb5-realm krb5-configuration))
...
(define-public desktop-extra-services (cons*
	      ...
	      (service pam-krb5-service-type-fixed (pam-krb5-configuration))
